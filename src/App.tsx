          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid gap-8 md:grid-cols-4 text-sm">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg font-semibold text-white">Kariyeer</span>
              </div>
              <p className="text-gray-400">
                Türkiye&apos;nin en kapsamlı kariyer koçluğu platformu. Hedeflerinize
                ulaşmanız için yanınızdayız.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <Link to="/kullanim-sozlesmesi" className="hover:text-white">
                    Kullanım Sözleşmesi
                  </Link>
                </li>
                <li>
                  <Link to="/kvkk-aydinlatma" className="hover:text-white">
                    KVKK Aydınlatma
                  </Link>
                </li>
              </ul>
