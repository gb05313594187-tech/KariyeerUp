...
import { Facebook, Instagram, Linkedin, Youtube, Twitter, MapPin, Mail, Phone, ShieldCheck } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 text-sm text-gray-300">
                ...
                <div className="flex items-center gap-3"><Phone className="w-4 h-4 text-orange-500"/> <span>0531 359 41 87</span></div>
          ...
          <div className="space-y-6">
            <div>
                ...
                <div className="flex flex-col gap-3">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Download_on_the_App_Store_Badge.svg" alt="App Store" className="h-10 w-32 cursor-pointer opacity-80 hover:opacity-100 transition-opacity"/>
