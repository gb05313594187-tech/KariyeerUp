...
export default function BookSession() {
  ...
  const coachId = searchParams.get("coachId"); // şimdilik gizli, ileride Supabase için kullanırız

  // Daha premium, düzenli saatler (her saat başı 09:00 - 20:00 arası)
  const timeSlots = [
    "09:00",
    "10:00",
    "11:00",
  ...
  const handleSubmit = (e: any) => {
    e.preventDefault();
    alert(
      "Rezervasyon isteğin alındı. Takvim ve ödeme akışı çok yakında koç ve senkronize takvimle entegre edilecek."
    );
  };
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mb-2">
              Tüm saatler koçun mevcut takvimiyle senkronize edilebilir. Şimdilik
              örnek slotlar gösterilmektedir.
            </p>
