        ...
        <div className="mt-10 space-y-8 text-gray-700">
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              satın alma adımında açıkça belirtilir. Platform, koç ile kullanıcı
              arasındaki iletişim için teknik altyapı sağlar.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              gerçekleştirilir. Kart bilgileri Kariyeer sistemlerinde saklanmaz.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              veya ifasına başlanmasıyla birlikte cayma hakkının
              sınırlanacağını kabul eder.
            </p>
          </section>
