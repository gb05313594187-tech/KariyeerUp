        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-8 text-red-50">
              {language === 'tr'
                ? 'Pasif gelir, profesyonel gelişim ve sektörde tanınırlık için ideal platform'
                : language === 'en'
                ? 'The ideal platform for passive income, professional development and industry recognition'
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              {language === 'tr'
                ...
                : language === 'en'
                ? 'Sustainable income, professional development and industry recognition'
                : 'Revenus durables, développement professionnel et reconnaissance dans l\'industrie'}
            </p>
          </div>
              ...
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
                  {language === 'tr'
                    ...
                    : language === 'en'
                    ? 'Coaches who stand out with active participation, quality content production and high client satisfaction are rewarded every week and month. Gain special showcase on homepage, badge and increased visibility.'
                    : 'Les coachs qui se distinguent par une participation active, une production de contenu de qualité et une satisfaction client élevée sont récompensés chaque semaine et chaque mois. Obtenez une vitrine spéciale sur la page d\'accueil, un badge et une visibilité accrue.'}
                </p>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              {language === 'tr'
                ...
                : language === 'en'
                ? 'Transparent, fair and sustainable income system'
                : 'Système de revenus transparent, équitable et durable'}
            </p>
          </div>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              {language === 'tr'
                ...
                : 'Nos normes de qualité et nos attentes'}
            </p>
          </div>
