...
const translations = {
  ...
  ar: {
    ...
    linkedinLogin: "تسجيل الدخول باستخدام LinkedIn",
  ...
  fr: {
    ...
    linkedinLogin: "Se connecter avec LinkedIn",
      ...
      <Card className="w-full max-w-md shadow-xl border-t-4 border-t-[#D32F2F]">
        ...
        <CardContent className="space-y-4">
          ...
          >
            ...
            {socialLoading === "google" ? "..." : t.googleLogin}
          </Button>
          ...
          >
            ...
            {socialLoading === "linkedin_oidc" ? "..." : t.linkedinLogin}
          </Button>
