...
export default function PaytrCheckout() {
  ...
  // ✅ PayTR token debug fetcher: invoke hata verirse manual fetch ile 400 body'yi çıkarır
  async function getPaytrTokenDebug(reqId: string) {
    ...
    // 2) invoke hata verdiyse: response body'yi görmek için manual fetch
    try {
      ...
      try {
        ...
        console.log("paytr-get-token manual json:", json);
      } catch (_) {}
    } catch (e) {
      console.error("manual fetch debug failed:", e);
    }
